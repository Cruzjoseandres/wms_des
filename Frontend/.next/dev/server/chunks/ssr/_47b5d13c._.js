...
function NuevoIngresoPage() {
    ...
    const selectedAlmacenId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stores$2f$ingresos$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useIngresosStore"])((s)=>s.selectedAlmacenId);
    ...
    const handleSubmit = async ()=>{
        ...
        if (!origen || !nroDocumento || itemsToSave.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Complete todos los campos requeridos");
            return;
        }
        ...
        try {
            await createIngresoBackend({
                nroDocumento,
                origen,
                almacenId: Number(selectedAlmacenId) || 1,
...
//# sourceMappingURL=_47b5d13c._.js.map