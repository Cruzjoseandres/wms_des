...
const MOCK_INGRESOS = [
    ...
    },
    {
        ...
        usuarioCreacion: "Fernando",
        usuarioValidacion: "Juan Pérez",
        usuarioAlmacenaje: "Carlos López",
        almacenId: "001"
    }
];
...
function NuevoIngresoPage() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const addIngreso = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stores$2f$ingresos$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIngresosStore"])({
        "NuevoIngresoPage.useIngresosStore[addIngreso]": (s)=>s.addIngreso
    }["NuevoIngresoPage.useIngresosStore[addIngreso]"]);
    ...
    const handleSearchApi = async ()=>{
        ...
        if (MOCK_API_DOCS[docSearch]) {
            ...
            setApiItems([]);
            setApiFound(false);
            alert("Documento no encontrado en sistema externo");
        }
    ...
    const handleSubmit = ()=>{
        ...
        if (!origen || itemsToSave.length === 0) {
            alert("Complete los campos requeridos");
            return;
        }
        const newIngreso = {
            id: String(Date.now()),
            documento: `ING-2025-${String(Date.now()).slice(-4)}`,
            tipo,
            origen,
            ...
            observaciones,
            usuarioCreacion: "Fernando",
            almacenId: selectedAlmacenId || "001"
        };
...
_s(NuevoIngresoPage, "Oh+ibtAk2OzILadd+r/wKrexIYc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_16c702d3._.js.map